	...
	<div class="col-lg-10">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-header">
                    <h3>
                        <p>Go to <a href="{{ route('doctor.index') }}">All Doctors</a></p>
                        <p><a href="{{ route('doctor.create') }}">Add new Doctor</a></p>
                    </h3>
                    <br/>
            ...
            <div class="card-body">
                <form class="forms-sample create_doctor" action="{{route('doctor.update', [$user->id])}}" method="post" enctype="multipart/form-data" >@csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('/images/'. $user->image) }}" style="width: 150px; height: auto;">
                                @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
