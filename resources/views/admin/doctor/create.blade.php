...
<div class="row justify-content-center">
	<div class="col-lg-10">
        ...
        <div class="card">
            <div class="card-header"><h3>Go to <a href="{{ route('doctor.index') }}">All Doctors</a></h3></div>
            <div class="card-header"><h3>Add doctor</h3></div>
            <div class="card-body">
                <form class="forms-sample create_doctor" action="{{route('doctor.store')}}" method="post" enctype="multipart/form-data" >@csrf
                    <div class="row">
                        <div class="col-lg-6">
