                            ...
                            <tbody>
                                @forelse( $bookings as $key=>$booking )
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('/profile/'.$booking->user->image) }}" width="80" style="border-radius: 50%;">
                                        </td>
                                        <td>
                                            {{$booking->date}}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @if(!App\Models\Prescription::where('date', date('Y-m-d'))->where('doctor_id', $user->id)->where('user_id',$booking->user->id)->exists())
